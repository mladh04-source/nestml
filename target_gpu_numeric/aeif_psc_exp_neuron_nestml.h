 ...
 *
 */
#ifndef AEIF_PSC_EXP_NEURON_NESTML_H
#define AEIF_PSC_EXP_NEURON_NESTML_H
...
const std::string aeif_psc_exp_neuron_nestml_scal_var_name[N_SCAL_VAR] = {
  "V_m",
  "w",
  "refr_t",
  "I_syn_exc",
...
const std::string aeif_psc_exp_neuron_nestml_scal_param_name[N_SCAL_PARAM] = {
  "C_m",
  "refr_T",
  "V_reset",
  "g_L",
...
const std::string aeif_psc_exp_neuron_nestml_port_var_name[N_PORT_VAR] = {
  "exc_spikes",
  "inh_spikes",
};
...
const std::string aeif_psc_exp_neuron_nestml_group_param_name[N_GROUP_PARAM] = {
  "h_min_rel",
  "h0_rel"
};
...
struct aeif_psc_exp_neuron_nestml_rk5
{
  int i_node_0_;
};
...
class aeif_psc_exp_neuron_nestml : public BaseNeuron
{
 public:
  RungeKutta5<aeif_psc_exp_neuron_nestml_rk5> rk5_;
  float h_min_;
  float h_;
  aeif_psc_exp_neuron_nestml_rk5 rk5_data_struct_;
